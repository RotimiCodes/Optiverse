package com.optimusbank.optiverseetoken.data.util;
...
public class Constants {
    ...
    public interface SharedPrefCredential {
        ...
        public String SHARED_PREF_CURRENCY_NAME = "sharedPreferencesCurrencyNameBootic";
        ...
        String INTENT_SUBCATEGORY_ID="sub_category_id";
    ...
    public interface Preferences {
        ...
        String PAYMENT_TYPE_KEY = "payment_type";
        String RAZOR_PAY_KEY = "razor_pay_key";
        String RAZOR_SECRET_KEY = "razor_pay_secret";
    ...
    public interface ServerUrl {
        ...
        //String MAIN_URL = "http://192.168.2.71/bootic-sub-category/public/";
        //String MAIN_URL = "https://theme1.w3engineers.com/bootic-test/public/";
        String MAIN_URL = "http://levigu.com:8080/dippsolutionapi/";
        ...
        String LOGIN_URL = "DippConnect/SubscriberLogin";
        ...
        String SUB_CATEGORY_BY_ID_URL = "sub-category/by-category.php";
        String PRODUCT_GRID_URL = "product/by-sub-category.php";
