package com.optimusbank.optiverseetoken.data.helper.encryption;
...
public class MCrypt {
    ...
    public static String encrypt(String key, String iv, String data) {
        try {
            ...
            String base64_EncryptedData = "12345678";
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                base64_EncryptedData = Base64.getEncoder().encodeToString(encryptedData);
            }else {
                base64_EncryptedData = android.util.Base64.encodeToString(encryptedData, android.util.Base64.DEFAULT);
            }
